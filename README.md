...
Apriori: Tìm mối liên hệ giữa các triệu chứng, chỉ số sức khỏe và khả năng mắc bệnh tim.

K-Means: Phân chia bệnh nhân thành các nhóm (cluster) để xây dựng hồ sơ rủi ro.

📊 Dữ liệu
Tập dữ liệu: HeartDiseaseTrain-Test.csv Kích thước: 1025 dòng, 14 cột.
...
🛠 Công nghệ sử dụng
Dự án được thực hiện bằng ngôn ngữ Python trên môi trường Jupyter Notebook. Các thư viện chính:
